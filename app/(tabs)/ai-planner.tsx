  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <ThemedText style={styles.title} numberOfLines={1} ellipsizeMode="tail">Seyahat Planları</ThemedText>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <ThemedText style={styles.cardDescription} numberOfLines={3} ellipsizeMode="tail">
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/plan-trip')}
          >
            <ThemedText style={styles.cardButtonText} numberOfLines={1} ellipsizeMode="tail">Başla</ThemedText>
        ...
        >
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/(tabs)/trip-details')}
          >
            <ThemedText style={styles.cardButtonText} numberOfLines={1} ellipsizeMode="tail">Planları Görüntüle</ThemedText>
            <MaterialCommunityIcons name="arrow-right" size={20} color="#fff" />
          </TouchableOpacity>
        </TouchableOpacity>

        <View style={styles.featuresContainer}>
          <ThemedText style={styles.featuresTitle} numberOfLines={1} ellipsizeMode="tail">Özellikler</ThemedText>
          ...
          <View style={styles.featuresList}>
            <View style={styles.featureRow}>
              <View style={styles.featureItem}>
                ...
                <ThemedText style={styles.featureText} numberOfLines={1} ellipsizeMode="tail">
